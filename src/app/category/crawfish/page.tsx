...
// Filtering seafoods to display only 'crawfish'
const seafoodsCards = seafoods.filter((seafood) => seafood.type === 'crawfish');

// Page component for displaying a grid of crawfish seafood items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered crawfish seafood items */}
