...
// Filtering seafoods to display only 'seafood_ink'
const seafoodsCards = seafoods.filter((seafood) => seafood.type === 'seafood_ink');

// Page component for displaying a grid of seafood ink items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered seafood ink items */}
