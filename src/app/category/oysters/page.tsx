...
// Filtering seafoods to display only 'oysters'
const seafoodsCards = seafoods.filter((seafood) => seafood.type === 'oysters');

// Page component for displaying a grid of oyster seafood items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered oyster seafood items */}
