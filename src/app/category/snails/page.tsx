...
// Filtering seafoods to display only 'snails'
const seafoodsCards = seafoods.filter((seafood) => seafood.type === 'snails');

// Page component for displaying a grid of snail seafood items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered snail seafood items */}
