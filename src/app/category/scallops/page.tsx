...
// Filtering seafoods to display only 'scallops'
const seafoodsCards = seafoods.filter(seafood => seafood.type === 'scallops');

// Page component for displaying a grid of scallop seafood items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered scallop seafood items */}
