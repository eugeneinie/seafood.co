...
// Filtering seafoods to display only 'crabs'
const seafoodsCards = seafoods.filter((seafood) => seafood.type === 'crabs');

// Page component for displaying a grid of crab seafood items
export default function Page() {
  return (
    <div className='relative left-52 grid sm:grid-cols-2 md:grid-cols-3 grid-cols-1 gap-4'>
      {/* Mapping through filtered crab seafood items */}
