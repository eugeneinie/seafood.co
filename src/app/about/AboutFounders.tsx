...
export default function AboutFounders() {
  return (
    ...
    <div className='relative left-20 h-[100px] w-[70px] rounded-md bg-slate-900 text-center'>
        <h2 className='font-bold'>Meet our founders</h2>
      <p>
    ...
    <div className="">
        <Image
            ...
            width={40}
            height={80}
            className='rounded-md relative left-2 '
        />
    </div>
    </div>
    </>
